...
def build_parser() -> argparse.ArgumentParser:
    """Build the command-line parser for trace evaluation."""

    parser = argparse.ArgumentParser(description="Run trace anomaly evaluation.")
...
def main() -> int:
    """Entry point for the trace evaluation CLI."""
