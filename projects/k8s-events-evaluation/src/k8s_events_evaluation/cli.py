...
def build_parser() -> argparse.ArgumentParser:
    """Build the command-line parser for Kubernetes event evaluation."""

    parser = argparse.ArgumentParser(description="Run Kubernetes event anomaly evaluation.")
...
def main() -> int:
    """Entry point for the Kubernetes event evaluation CLI."""
