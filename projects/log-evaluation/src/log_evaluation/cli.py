...
def build_parser() -> argparse.ArgumentParser:
    """Build the command-line parser for log evaluation."""

    parser = argparse.ArgumentParser(description="Run log anomaly evaluation.")
...
def main() -> int:
    """Entry point for the log evaluation CLI."""
